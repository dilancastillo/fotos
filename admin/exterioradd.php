<?php
session_start();
$title = "Agregar Exterior";
/* Llamar la Cadena de Conexion*/
include("../conexion.php");
//Insert un nuevo producto
$imagen_demo = "demo.png";
$insert = mysqli_query($con, "insert into exterior (url_image, estado) values ('$imagen_demo','0')");
$sql_last = mysqli_query($con, "select LAST_INSERT_ID(id) as last from exterior order by id desc limit 0,1");
$rw = mysqli_fetch_array($sql_last);
$id_exterior = intval($rw['last']);
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-7">
				<h3><span class="glyphicon glyphicon-edit"></span> Agregar exterior</h3>
